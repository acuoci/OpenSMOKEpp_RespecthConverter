...
class Respecth2OpenSMOKEpp_BurnerStabilizedFlameSpeciation : public Respecth2OpenSMOKEpp
{
public:

	Respecth2OpenSMOKEpp_BurnerStabilizedFlameSpeciation(	const boost::filesystem::path file_name,
...
private:
	...
	std::vector<double> x_profile_values_;
	std::string x_profile_units_;

	std::vector<double> t_profile_values_;
	std::string t_profile_units_;
